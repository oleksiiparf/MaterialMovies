...
/**
 * Created by Roodie on 28.09.2015.
 */
public class MMoviesStarView extends ImageView {
    ...
    public MMoviesStarView(Context context) {
        super(context);
    }

    public MMoviesStarView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public MMoviesStarView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    @TargetApi(21)
    public MMoviesStarView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void startRemoveStarAnimation() {
        ...
        new ExplodeAnimation(this).setDuration(200).setListener(new AnimationListener() {
            @Override public void onAnimationEnd(Animation animation) {
                setStarred(false);
                new FadeInAnimation(MMoviesStarView.this).setDuration(100).setListener(new AnimationListener() {
                    @Override public void onAnimationEnd(Animation animation) {
                        triggerClick();
                    }
                }).animate();
