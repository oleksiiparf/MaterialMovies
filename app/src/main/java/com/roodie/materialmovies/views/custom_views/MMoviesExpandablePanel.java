...
/**
 * Created by Roodie on 01.12.2015.
 */
public class MMoviesExpandablePanel extends LinearLayout {
    ...
    public MMoviesExpandablePanel(Context context) {
        this(context, null);
    }
     ...
     * 'handle' and 'content'
     */
    public MMoviesExpandablePanel(Context context, AttributeSet attrs) {
        super(context, attrs);
