 ...
 */
public class MovieCreditWrapper extends BasicWrapper implements Comparable<MovieCreditWrapper> {
    ...
    public MovieCreditWrapper(PersonWrapper person, String job, int order) {
    ...
    public MovieCreditWrapper(PersonWrapper person, String job, String department) {
        this.person = Preconditions.checkNotNull(person, "Person cannot be null");
        this.job = Preconditions.checkNotNull(job, "Job cannot be null");
    ...
    @Override
    public int compareTo(MovieCreditWrapper another) {
    ...
    private static int crewOrderByJob(MovieCreditWrapper crew) {
